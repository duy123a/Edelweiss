    ...
    private static void SeedData(AuctionDbContext? context)
    {
        ...
        var auctions = new List<Auction>()
        {
            ...
            new Auction
            {
                ...
                ReservePrice = 20000,
                Seller = "bob",
                DateAuctionEnd = DateTime.UtcNow.AddDays(10),
                Item = new Item
                {
                    Creator = "Ford",
                    Model = "GT",
            ...
            new Auction
            {
                ...
                ReservePrice = 90000,
                Seller = "alice",
                DateAuctionEnd = DateTime.UtcNow.AddDays(60),
                Item = new Item
                {
                    Creator = "Bugatti",
                    Model = "Veyron",
            ...
            new Auction
            {
                ...
                Status = Status.Live,
                Seller = "bob",
                DateAuctionEnd = DateTime.UtcNow.AddDays(4),
                Item = new Item
                {
                    Creator = "Ford",
                    Model = "Mustang",
            ...
            new Auction
            {
                ...
                ReservePrice = 20000,
                Seller = "alice",
                DateAuctionEnd = DateTime.UtcNow.AddDays(30),
                Item = new Item
                {
                    Creator = "BMW",
                    Model = "X1",
